  ...
  return (
    ...
    >
      {isFilled ? (
        ...
        <>
          <path
            d="M5 9C5 8.44772 5.44772 8 6 8H17V14C17 16.2091 15.2091 18 13 18H9C6.79086 18 5 16.2091 5 14V9Z"
            stroke={color}
            strokeWidth="1.5"
          />
          <path d="M3 21L21 21" stroke={color} strokeLinecap="round" strokeWidth="1.5" />
          <path
            d="M17 8H18C19.1046 8 20 8.89543 20 10V10C20 11.1046 19.1046 12 18 12H17V8Z"
            stroke={color}
            strokeWidth="1.5"
          />
          <path
            d="M9 6L8.90155 5.76372C8.68682 5.24836 8.96524 4.66043 9.5 4.5C10.0348 4.33957 10.3132 3.75164 10.0984 3.23628L10 3"
            stroke={color}
            strokeLinecap="round"
            strokeWidth="1.5"
          />
          <path
            d="M13 6L12.9016 5.76372C12.6868 5.24836 12.9652 4.66043 13.5 4.5C14.0348 4.33957 14.3132 3.75164 14.0984 3.23628L14 3"
            stroke={color}
            strokeLinecap="round"
            strokeWidth="1.5"
          />{' '}
