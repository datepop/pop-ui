  ...
  return (
    ...
    >
      {isFilled ? (
        ...
        <>
          <path
            d="M3.32972 17.7395L10.7071 5.19793C11.2871 4.21197 12.7129 4.21197 13.2929 5.19793L20.6703 17.7395C21.2585 18.7394 20.5375 20 19.3774 20H4.62262C3.4625 20 2.74152 18.7394 3.32972 17.7395Z"
            stroke={color}
            strokeWidth="1.5"
          />
          <path d="M12 9.5V13.5" stroke={color} strokeLinecap="round" strokeWidth="1.5" />
