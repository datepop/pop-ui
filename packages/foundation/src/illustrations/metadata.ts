...
export const illustrationMetadata: Record<TIllustrationName, IIllustrationMetadataEntry> = {
  ...
  IllustrationExclamation: { categories: [IllustrationCategory.SYSTEM] },
  ...
  IllustrationMegaphoneBlue: { categories: [IllustrationCategory.STATUS] },
  ...
  IllustrationPeopleGray: { categories: [IllustrationCategory.CONTENT] },
  IllustrationPerson: { categories: [IllustrationCategory.CONTENT] },
  IllustrationPopcorn: { categories: [IllustrationCategory.CONTENT] },
  IllustrationPopcornFull: { categories: [IllustrationCategory.CONTENT] },
  IllustrationPopcornPayback: { categories: [IllustrationCategory.CONTENT] },
  ...
  IllustrationWrite: { categories: [IllustrationCategory.ACTION] },
